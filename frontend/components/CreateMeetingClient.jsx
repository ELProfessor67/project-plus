...
const CreateMeetingClient = ({ open, onClose, isScheduled, getMeetings, project_id = null }) => {
    ...
    }, [selectTask, selectProject, selectClient, heading, description,isScheduled,date,time]);
